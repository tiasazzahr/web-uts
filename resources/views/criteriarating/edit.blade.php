                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('criteriaratings.update', $criteriarating->id)}}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="rating">Criteria :</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="rating" type="number" step="0.01" class="form-control" placeholder="e.g. 2.5"
                                            name="rating" value="{{ $criteriarating->rating }}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="description" type="number" step="0.01" class="form-control" placeholder="e.g. Good"
